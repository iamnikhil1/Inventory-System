    ...
    <div class="main-content">
      ...
      <table id="leadTable">
        ...
        <tbody>
          ...
          $limit = 12; // Number of entries per page (updated to 10)
          ...
          if (mysqli_num_rows($result) > 0) {
            ...
            while ($rows = mysqli_fetch_assoc($result)) {
              ...
              <tr>
                  ...
                  <td><?php echo $rows['quotation_number']; ?></td>
                  <td><?php echo $rows['client_name']; ?></td>
                  <td><?php echo $rows['invoice_date']; ?></td>
                  <td>
                      <?php if ($rows['status'] == 'pending') { ?>
                          <button class="btn-primary" onclick="acceptInvoice(<?php echo $rows['id']; ?>)">Accept</button>
                      <?php } else { ?>
...
function acceptInvoice(invoiceId) {
    if (confirm("Are you sure you want to accept this invoice?")) {
        fetch('accept_invoice.php?id=' + invoiceId)
