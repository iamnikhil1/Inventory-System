    ...
    <div class="main-content">
      ...
      <table id="leadTable">
        ...
        <tbody>
          ...
          $query = "SELECT * FROM unit_of_measurement LIMIT $limit OFFSET $offset";
          $result = mysqli_query($conn, $query);

          // Get total number of entries
          $count_query = "SELECT COUNT(*) as total FROM unit_of_measurement";
          ...
          <tr>
            ...
            <td>
              <a href='edit_unit.php?id=<?php echo $rows['id']; ?>'><img src="edit.svg" alt="Edit" style="width: 20px; height: 20px;"></a>
              <a href='delete_unit.php?id=<?php echo $rows['id']; ?>' 
