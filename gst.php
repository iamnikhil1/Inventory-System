  ...
  <div class="content">
    <div class="main-content">
      ...
      <!-- Left-aligned heading -->
        ...
        <a href="add_gst.php" class="plus-icon" title="Add Gst">
      ...
      <table id="leadTable">
        ...
        <tbody>
          ...
          $query = "SELECT * FROM gst LIMIT $limit OFFSET $offset";
          $result = mysqli_query($conn, $query);

          // Get total number of entries
          $count_query = "SELECT COUNT(*) as total FROM gst";
          ...
          <tr>
            ...
            <td>
              <a href='edit_gst.php?id=<?php echo $rows['id']; ?>'><img src="edit.svg" alt="Edit" style="width: 20px; height: 20px;"></a>
              <a href='delete_gst.php?id=<?php echo $rows['id']; ?>' 
