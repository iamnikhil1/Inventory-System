  ...
  <div class="content">
    <div class="main-content">
      ...
      <!-- Left-aligned heading -->
        ...
        <a href="add_item_unit.php" class="plus-icon" title="Add unit_of_ measurement">
      ...
      <table id="leadTable">
        ...
        <tbody>
          ...
          $query = "SELECT * FROM item_unit LIMIT $limit OFFSET $offset";
          $result = mysqli_query($conn, $query);

          // Get total number of entries
          $count_query = "SELECT COUNT(*) as total FROM item_unit";
          ...
          <tr>
            ...
            <td>
              <a href='edit_item_unit.php?id=<?php echo $rows['id']; ?>'><img src="edit.svg" alt="Edit" style="width: 20px; height: 20px;"></a>
              <a href='delete_item_unit.php?id=<?php echo $rows['id']; ?>' 
