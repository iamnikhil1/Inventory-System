    ...
    <div class="main-content">
      ...
      <table id="leadTable">
        ...
        <tbody>
          ...
          $query = "SELECT * FROM items_list LIMIT $limit OFFSET $offset";
          $result = mysqli_query($conn, $query);

          // Get total number of entries
          $count_query = "SELECT COUNT(*) as total FROM items_list";
          ...
          <tr>
            ...
            <td>
              <a href='edit_items_list.php?id=<?php echo $rows['id']; ?>'><img src="edit.svg" alt="Edit" style="width: 20px; height: 20px;"></a>
              <a href='delete_items_list.php?id=<?php echo $rows['id']; ?>' 
