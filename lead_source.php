    ...
    <div class="main-content">
      ...
      <table id="leadTable">
        ...
        <tbody>
          ...
          $query = "SELECT * FROM source_lead LIMIT $limit OFFSET $offset";
          $result = mysqli_query($conn, $query);

          // Get total number of entries
          $count_query = "SELECT COUNT(*) as total FROM source_lead";
          ...
          <tr>
            ...
            <td>
              <a href='edit_lead_source.php?id=<?php echo $rows['id']; ?>'><img src="edit.svg" alt="Edit" style="width: 20px; height: 20px;"></a>
              <a href='delete_lead_source.php?id=<?php echo $rows['id']; ?>'><img src="delete.png" alt="Delete" style="width: 20px; height: 20px;"></a>
            </td>
          </tr>
          <?php
            }
