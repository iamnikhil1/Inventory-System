  ...
  <div class="content">
    <div class="main-content">
      ...
      <!-- Left-aligned heading -->
        <h2 id="headd">Designation</h2>

        <!-- Centered search bar -->
        <input type="text" id="searchBar" class="form-control search-bar" placeholder="Search for...">

        <!-- Right-aligned plus icon -->
        <a href="add_designation.php" class="plus-icon" title="Add designation">
          <img src="plus.png" alt="Add designation">
        </a>
      </div>
      ...
      <table id="leadTable">
        ...
        <tbody>
          ...
          $query = "SELECT * FROM designation LIMIT $limit OFFSET $offset";
          $result = mysqli_query($conn, $query);

          // Get total number of entries
          $count_query = "SELECT COUNT(*) as total FROM designation";
          ...
          <tr>
            ...
            <td>
              <a href='edit_designation.php?id=<?php echo $rows['id']; ?>'><img src="edit.svg" alt="Edit" style="width: 20px; height: 20px;"></a>
              <a href='delete_designation.php?id=<?php echo $rows['id']; ?>'><img src="delete.png" alt="Delete" style="width: 20px; height: 20px;"></a>
            </td>
          </tr>
          <?php
            }
