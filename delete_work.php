...
$query = "DELETE FROM work_experience_details WHERE id = ?";
...
if ($stmt->execute()) {
    ...
    $sql_check = "SELECT MAX(id) AS max_id FROM work_experience_details";
    ...
    if ($result_check) {
        ...
        $sql_reset = "ALTER TABLE work_experience_details AUTO_INCREMENT = {$next_id}";
