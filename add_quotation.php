...
<div class="container">
  ...
  <div class="content">
	...
	<form id="invoiceForm" action="save_quotation.php" method="POST">
		<div class="header-section">
			...
			<div class="right-section">
				...
				<input type="text" name="quotation_number" id="quotation_number" required readonly>
		...
		<div class="summary-container">
			<div class="summary-card">
				...
				<div class="save-button">
					<button type="submit" id="saveInvoice" onclick="saveInvoice()">Save Quotation</button>
				</div>
...
function fetchProductDetails(select) {
    ...
    // Set hidden item number
    row.querySelector('.item-number').value = itemNumber;

    // Update rate and GST fields
    row.cells[4].querySelector("input").value = selectedOption.getAttribute("data-rate"); // Update rate input
    ...
    let unitNameInput = row.cells[1].querySelector("input[name='unit_cleaned[]']") || document.createElement("input");
    ...
    // Handle GST based on client and shipper state
